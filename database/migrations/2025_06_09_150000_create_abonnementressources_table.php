...
return new class extends Migration
{
    ...
    {
        Schema::create('abonnementressources', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('abonnement_id')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('abonnementressources');
    }
