...
return new class extends Migration
{
    ...
    {
        Schema::create('cotisationressources', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('cotisation_id')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('cotisationressources');
    }
