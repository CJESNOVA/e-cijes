                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-7">
                                    <div class="hero-right">
                                        <div class="image-box">
                                            <img src="{{ env('SUPABASE_BUCKET_URL') . '/' . $slider->vignette }}" alt="">
                                        </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="brand-item">
                                                <a class="image" href="{{ env('APP_URL') }}partenaire/{{ $partenaire->id }}-{{ getEnleveAccent($partenaire->titre) }}.html">
                                                    <img src="{{ env('SUPABASE_BUCKET_URL') . '/' . $partenaire->vignette }}" alt="{{ $partenaire->titre }}" class="img-fluid" style="max-height: 80px; width: auto !important; object-fit: contain;">
                                                </a>
                                            </div>
                                        </div>
                                        @endif
